...
exports.Request = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:Marketplace.Trading.Matching.Service:Request',
...
exports.Offer = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:Marketplace.Trading.Matching.Service:Offer',
  keyDecoder: damlTypes.lazyMemo(function () { return jtv.constant(undefined); }),
  keyEncode: function () { throw 'EncodeError'; },
...
exports.MatchOrders = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({execution: Marketplace_Trading_Model.Execution.decoder, }); }),
  encode: function (__typed__) {
  return {
...
exports.Service = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:Marketplace.Trading.Matching.Service:Service',
...
,
  MatchOrders: {
    ...
    choiceName: 'MatchOrders',
    argumentDecoder: damlTypes.lazyMemo(function () { return exports.MatchOrders.decoder; }),
    argumentEncode: function (__typed__) { return exports.MatchOrders.encode(__typed__); },
    resultDecoder: damlTypes.lazyMemo(function () { return exports.MatchResult.decoder; }),
    resultEncode: function (__typed__) { return exports.MatchResult.encode(__typed__); },
  },
  Terminate: {
    template: function () { return exports.Service; },
...
exports.MatchResult = {
  decoder: damlTypes.lazyMemo(function () { return jtv.oneOf(jtv.object({tag: jtv.constant('Cleared'), value: damlTypes.ContractId(Marketplace_Clearing_Model.ClearedTrade).decoder, }), jtv.object({tag: jtv.constant('Collateralized'), value: damlTypes.ContractId(Marketplace_Settlement_Model.SettlementInstruction).decoder, })); }),
  encode: function (__typed__) {
  switch(__typed__.tag) {
    case 'Cleared': return {tag: __typed__.tag, value: damlTypes.ContractId(Marketplace_Clearing_Model.ClearedTrade).encode(__typed__.value)};
    case 'Collateralized': return {tag: __typed__.tag, value: damlTypes.ContractId(Marketplace_Settlement_Model.SettlementInstruction).encode(__typed__.value)};
    default: throw 'unrecognized type tag: ' + __typed__.tag + ' while serializing a value of type MatchResult';
  }
}
,
};
