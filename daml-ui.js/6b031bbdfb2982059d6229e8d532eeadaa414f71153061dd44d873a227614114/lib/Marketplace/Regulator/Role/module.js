...
var Marketplace_Regulator_Service = require('../../../Marketplace/Regulator/Service/module');
...
exports.Request = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:Marketplace.Regulator.Role:Request',
...
exports.Offer = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:Marketplace.Regulator.Role:Offer',
  keyDecoder: damlTypes.lazyMemo(function () { return jtv.constant(undefined); }),
  keyEncode: function () { throw 'EncodeError'; },
...
exports.TerminateRegulatorService = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({regulatorServiceCid: damlTypes.ContractId(Marketplace_Regulator_Service.Service).decoder, }); }),
  encode: function (__typed__) {
  return {
    regulatorServiceCid: damlTypes.ContractId(Marketplace_Regulator_Service.Service).encode(__typed__.regulatorServiceCid),
  };
}
,
};
...
exports.ApproveRegulatorRequest = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({regulatorRequestCid: damlTypes.ContractId(Marketplace_Regulator_Service.Request).decoder, }); }),
  encode: function (__typed__) {
  return {
    regulatorRequestCid: damlTypes.ContractId(Marketplace_Regulator_Service.Request).encode(__typed__.regulatorRequestCid),
  };
}
,
};
...
exports.Role = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:Marketplace.Regulator.Role:Role',
...
,
  OfferRegulatorService: {
    template: function () { return exports.Role; },
    choiceName: 'OfferRegulatorService',
    argumentDecoder: damlTypes.lazyMemo(function () { return exports.OfferRegulatorService.decoder; }),
    argumentEncode: function (__typed__) { return exports.OfferRegulatorService.encode(__typed__); },
    resultDecoder: damlTypes.lazyMemo(function () { return damlTypes.ContractId(Marketplace_Regulator_Service.Offer).decoder; }),
    resultEncode: function (__typed__) { return damlTypes.ContractId(Marketplace_Regulator_Service.Offer).encode(__typed__); },
  },
  ApproveRegulatorRequest: {
    ...
    resultDecoder: damlTypes.lazyMemo(function () { return damlTypes.ContractId(Marketplace_Regulator_Service.Service).decoder; }),
    resultEncode: function (__typed__) { return damlTypes.ContractId(Marketplace_Regulator_Service.Service).encode(__typed__); },
  },
  TerminateRegulatorService: {
    template: function () { return exports.Role; },
    choiceName: 'TerminateRegulatorService',
    argumentDecoder: damlTypes.lazyMemo(function () { return exports.TerminateRegulatorService.decoder; }),
    argumentEncode: function (__typed__) { return exports.TerminateRegulatorService.encode(__typed__); },
    resultDecoder: damlTypes.lazyMemo(function () { return damlTypes.Unit.decoder; }),
    resultEncode: function (__typed__) { return damlTypes.Unit.encode(__typed__); },
  },
  TerminateRole: {
