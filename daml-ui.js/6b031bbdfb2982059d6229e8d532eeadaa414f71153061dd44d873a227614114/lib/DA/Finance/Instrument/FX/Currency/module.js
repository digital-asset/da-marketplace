...
exports.Currency = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:DA.Finance.Instrument.FX.Currency:Currency',
  ...
  decoder: damlTypes.lazyMemo(function () { return jtv.object({id: DA_Finance_Types.Id.decoder, isoCode: damlTypes.Text.decoder, observers: pkg97b883cd8a2b7f49f90d5d39c981cf6e110cf1f1c64427a28a6d58ec88c43657.DA.Set.Types.Set(damlTypes.Party).decoder, }); }),
  encode: function (__typed__) {
  return {
    id: DA_Finance_Types.Id.encode(__typed__.id),
    isoCode: damlTypes.Text.encode(__typed__.isoCode),
...
,
  ...
  EquityStock_SetObservers: {
    ...
    resultDecoder: damlTypes.lazyMemo(function () { return damlTypes.ContractId(exports.Currency).decoder; }),
    resultEncode: function (__typed__) { return damlTypes.ContractId(exports.Currency).encode(__typed__); },
  },
};


damlTypes.registerTemplate(exports.Currency);
