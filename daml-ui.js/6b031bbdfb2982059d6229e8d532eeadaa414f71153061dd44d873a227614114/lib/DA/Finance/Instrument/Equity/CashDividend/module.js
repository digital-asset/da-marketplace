...
exports.EquityCashDividend = {
  templateId: '6b031bbdfb2982059d6229e8d532eeadaa414f71153061dd44d873a227614114:DA.Finance.Instrument.Equity.CashDividend:EquityCashDividend',
  ...
  decoder: damlTypes.lazyMemo(function () { return jtv.object({id: DA_Finance_Types.Id.decoder, exDate: damlTypes.Date.decoder, settlementDate: damlTypes.Date.decoder, perShare: damlTypes.Numeric(10).decoder, observers: pkg97b883cd8a2b7f49f90d5d39c981cf6e110cf1f1c64427a28a6d58ec88c43657.DA.Set.Types.Set(damlTypes.Party).decoder, }); }),
  encode: function (__typed__) {
  return {
    ...
    perShare: damlTypes.Numeric(10).encode(__typed__.perShare),
...
,
  ...
  EquityCashDividend_SetObservers: {
    ...
    argumentDecoder: damlTypes.lazyMemo(function () { return exports.EquityCashDividend_SetObservers.decoder; }),
    argumentEncode: function (__typed__) { return exports.EquityCashDividend_SetObservers.encode(__typed__); },
    resultDecoder: damlTypes.lazyMemo(function () { return damlTypes.ContractId(exports.EquityCashDividend).decoder; }),
    resultEncode: function (__typed__) { return damlTypes.ContractId(exports.EquityCashDividend).encode(__typed__); },
  },
};
