          ...
          <Grid container>
              ...
              <Grid container justify="center">
                <Card className={classes.root}>
                  <Box border={2} borderColor="primary.main">
                    <CardActionArea onClick={() => history.push("/apps/structuring/instruments/new/binaryoption")}>
            ...
            <Grid item xs={4}>
              <Grid container justify="center">
                <Card className={classes.root}>
                  <Box border={2} borderColor="primary.main">
                    <CardActionArea onClick={() => history.push("/apps/structuring/instruments/new/convertiblenote")}>
