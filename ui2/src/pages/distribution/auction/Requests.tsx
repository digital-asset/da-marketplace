                ...
                <TableBody>
                  {requests.map((c, i) => (
                    <TableRow key={i} className={classes.tableRow}>
                      ...
                      <TableCell key={2} className={classes.tableCell}>{c.payload.auctionId}</TableCell>
                      ...
                      <TableCell key={5} className={classes.tableCell}>{c.payload.floorPrice} {c.payload.quotedAssetId.label}</TableCell>
