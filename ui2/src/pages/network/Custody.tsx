...
import { Role }  from '@daml.js/da-marketplace/lib/Marketplace/Custodian'
import { Service, Request, Offer } from '@daml.js/da-marketplace/lib/Marketplace/Custody'
...
const CustodyComponent : React.FC<RouteComponentProps> = ({ history } : RouteComponentProps) => {
  ...
  const approveRequest = async (c : CreateEvent<Request>) => {
    ...
    await ledger.exercise(Role.AcceptCustodyRequest, roles[0].contractId, { custodyRequestCid: c.contractId });
  }
