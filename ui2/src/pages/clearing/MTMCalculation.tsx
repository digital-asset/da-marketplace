...
import {Service, CreateMarkToMarket} from "@daml.js/da-marketplace/lib/Marketplace/Clearing/Service";
...
const MTMCalculationComponent: React.FC<RouteComponentProps & ServicePageProps<Service>> = ({ history, services }: RouteComponentProps & ServicePageProps<Service>) => {
