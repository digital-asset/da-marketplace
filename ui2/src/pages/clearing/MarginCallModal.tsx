...
const MarginCallModal: React.FC<ServicePageProps<Service>> = ({
  services,
  ...
  const canRequest = !!customer && !!targetAmount;
...
const MarginCallComponent: React.FC<ServicePageProps<Service>> = ({
  services,
}: ServicePageProps<Service>) => {
  const party = useParty();
  const ledger = useLedger();
