...
```
daml build
daml codegen js .daml/dist/da-marketplace-0.1.22.dar -o daml.js
cd ui
...
Finally, upload the `da-marketplace-exberry-adapter-0.1.22.tar.gz` file in the `target` folder and launch the automation as `Exchange`.
