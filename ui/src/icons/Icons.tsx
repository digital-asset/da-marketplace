...
export const ExchangeIcon: React.FC<IconProps> = ({ size, color }) => (
    <svg className={`icon exchange-icon icon-size-${size}`} width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path className={color ? `fill-${color}`: ''} d="M15.5303 6.53033C15.8232 6.23744 15.8232 5.76256 15.5303 5.46967L10.7574 0.696699C10.4645 0.403806 9.98959 0.403806 9.6967 0.696699C9.40381 0.989593 9.40381 1.46447 9.6967 1.75736L13.9393 6L9.6967 10.2426C9.40381 10.5355 9.40381 11.0104 9.6967 11.3033C9.98959 11.5962 10.4645 11.5962 10.7574 11.3033L15.5303 6.53033ZM1 6.75H15V5.25H1V6.75Z" fill="#4E5E7E"/>
        <path className={color ? `fill-${color}`: ''} d="M0.46967 14.5303C0.176777 14.2374 0.176777 13.7626 0.46967 13.4697L5.24264 8.6967C5.53553 8.40381 6.01041 8.40381 6.3033 8.6967C6.59619 8.98959 6.59619 9.46447 6.3033 9.75736L2.06066 14L6.3033 18.2426C6.59619 18.5355 6.59619 19.0104 6.3033 19.3033C6.01041 19.5962 5.53553 19.5962 5.24264 19.3033L0.46967 14.5303ZM15 14.75H1V13.25H15V14.75Z" fill="#4E5E7E"/>
    </svg>
)

export const LockIcon = () => (
    <svg className="icon lock-icon" width="14" height="20" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="6" width="12" height="10.6667" stroke="#131720" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M3.66602 6.33333C3.82475 4.55556 3.66602 1 6.99935 1C10.3327 1 10.174 4.55556 10.3327 6.33333" stroke="#131720"/>
        <line x1="7" y1="10" x2="7" y2="12.6667" stroke="#131720" strokeWidth="2" strokeLinejoin="round"/>
    </svg>
)

export const LogoutIcon = () => (
    <svg className="icon logout-icon" width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M11.941 6.50026L3.751 6.50026C3.337 6.50026 3.001 6.83626 3.001 7.25026C3.001 7.66426 3.337 8.00026 3.751 8.00026H11.941L9.221 10.7193C9.075 10.8663 9.001 11.0583 9.001 11.2503C9.001 11.4423 9.075 11.6343 9.221 11.7803C9.514 12.0733 9.989 12.0733 10.282 11.7803L14.282 7.78026C14.351 7.71126 14.406 7.62826 14.443 7.53626C14.519 7.35326 14.519 7.14626 14.443 6.96326C14.406 6.87126 14.351 6.78926 14.282 6.71926L10.282 2.71926C9.989 2.42626 9.514 2.42626 9.221 2.71926C8.928 3.01226 8.928 3.48726 9.221 3.78026L11.941 6.50026Z" fill="#174DE8"/>
        <path fillRule="evenodd" clipRule="evenodd" d="M6.75098 12.5H1.50098L1.50098 2H6.75098V0.5L0.750977 0.5C0.336977 0.5 0.000976562 0.836 0.000976562 1.25L0.000976563 13.25C0.000976563 13.664 0.336977 14 0.750977 14H6.75098V12.5Z" fill="#174DE8"/>
    </svg>
)
